...
Code Credits:
 ...
 - 2. ZhouDaxia233
   ...
   - GitHub Repository: https://github.com/zhoudaxia233/PyTorch-Unet/tree/master
...
def vgg13bn_unet(output_dim: int=4, pretrained: bool=False):
    return VGGUnet(vgg13_bn, pretrained=pretrained, out_channels=output_dim)


def vgg16bn_unet(output_dim: int=4, pretrained: bool=False):
